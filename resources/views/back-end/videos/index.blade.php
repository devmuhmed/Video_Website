                ...
                <tbody>
                    @foreach ($rows as $row)
                        <tr>
                            ...
                            <td>
                                <a href="#"
                                    class="text-dark fw-bolder text-hover-primary mb-1 fs-6">{{ $row->category->name }}</a>
                            </td>
                            <td>
                                <a href="#"
                                    class="text-dark fw-bolder text-hover-primary mb-1 fs-6">{{ $row->user->name }}</a>
                            </td>
